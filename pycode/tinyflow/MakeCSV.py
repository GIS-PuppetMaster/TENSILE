...
file_list = ['VGG x1', 'VGG x2', 'VGG x3', 'VGG MDW', 'VGG bs4', 'VGG bs8', 'VGG bs32',
             ...
             'ResNet x1', 'ResNet x2', 'ResNet x3', 'ResNet MDW', 'ResNet bs4', 'ResNet bs8', 'ResNet bs32',
             'DenseNet x1', 'DenseNet x2', 'DenseNet x3', 'DenseNet MDW', 'DenseNet bs4', 'DenseNet bs8']
...
batch_size_workloads = ['VGG bs4', 'VGG bs8', 'VGG x1', 'VGG bs32',
                        'Inception V3 bs4', 'Inception V3 bs8', 'Inception V3 x1', 'Inception V3 bs32',
                        'Inception V4 bs4', 'Inception V4 bs8', 'Inception V4 x1',  'Inception V4 bs32',
                        'ResNet bs4', 'ResNet bs8', 'ResNet x1', 'ResNet bs32',
                        'DenseNet bs4', 'DenseNet bs8', 'DenseNet x1', 'DenseNet bs32']
...
def make_csv():
    ...
    for file in batch_size_workloads:
        ...
        with open(path, 'r') as f:
            lines = f.readlines()
        for i, line in enumerate(lines):
            col = batch_size_workloads.index(file)%4
